                ...
                <ul>
                    ...
                    <li class="submenu"> 
                        ...
                        <ul style="display: none;">
                            ...
                            <li><a class="active" href="<?php echo e(url('form/performance/appraisal/page')); ?>"> Performance Appraisal </a></li>
                        </ul>
                    </li>
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-striped custom-table mb-0 datatable">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $appraisals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$appraisal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e(++$key); ?></td>
                                    <td hidden class="id"><?php echo e($appraisal->id); ?></td>
                                    <td hidden class="name"><?php echo e($appraisal->name); ?></td>
                                    <td hidden class="date"><?php echo e($appraisal->date); ?></td>
                                    <td hidden class="designation"><?php echo e($appraisal->name); ?></td>
                                    <td hidden class="customer_experience"><?php echo e($appraisal->customer_experience); ?></td>
                                    <td hidden class="marketing"><?php echo e($appraisal->marketing); ?></td>
                                    <td hidden class="management"><?php echo e($appraisal->management); ?></td>
                                    <td hidden class="administration"><?php echo e($appraisal->administration); ?></td>
                                    <td hidden class="presentation_skill"><?php echo e($appraisal->presentation_skill); ?></td>
                                    <td hidden class="quality_of_work"><?php echo e($appraisal->quality_of_Work); ?></td>
                                    <td hidden class="efficiency"><?php echo e($appraisal->efficiency); ?></td>
                                    <td hidden class="integrity"><?php echo e($appraisal->integrity); ?></td>
                                    <td hidden class="professionalism"><?php echo e($appraisal->professionalism); ?></td>
                                    <td hidden class="team_work"><?php echo e($appraisal->team_work); ?></td>
                                    <td hidden class="critical_thinking"><?php echo e($appraisal->critical_thinking); ?></td>
                                    <td hidden class="conflict_management"><?php echo e($appraisal->conflict_management); ?></td>
                                    <td hidden class="attendance"><?php echo e($appraisal->attendance); ?></td>
                                    <td hidden class="ability_to_meet_deadline"><?php echo e($appraisal->ability_to_meet_deadline); ?></td>
                                    <td hidden class="status"><?php echo e($appraisal->status); ?></td>

                                    <td>
                                        <h2 class="table-avatar">
                                            <a href="profile.html" class="avatar"><img alt="" src="<?php echo e(URL::to('/assets/images/'. $appraisal->avatar)); ?>" alt="<?php echo e($appraisal->avatar); ?>"></a>
                                            <a href="profile.html"><?php echo e($appraisal->name); ?> </a>
                                        </h2>
                                    </td>
                                    <td><?php echo e($appraisal->department); ?></td>
                                    <td><?php echo e(date('d F, Y',strtotime($appraisal->created_at))); ?></td>
                                    <td>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?php echo e(url('form/performance/appraisal/save')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="select" id="name" name="name">
                                            ...
                                            <option value="<?php echo e($user->name); ?>" data-employee_id=<?php echo e($user->rec_id); ?>><?php echo e($user->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
        ...
        <div id="edit_appraisal" class="modal custom-modal fade" role="dialog">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?php echo e(url('form/performance/appraisal/update')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="select" id="e_name" name="name">
                                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option disabled value="<?php echo e($user->name); ?>"><?php echo e($user->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                    <div class="form-group">
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <div class="modal-btn delete-action">
                            <form action="<?php echo e(url('form/performance/appraisal/delete')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRS\resources\views\performance\performanceappraisal.blade.php ENDPATH**/ ?>