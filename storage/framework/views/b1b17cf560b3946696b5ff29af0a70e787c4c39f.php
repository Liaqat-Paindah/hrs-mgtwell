                                ...
                                <a href="#" class="dash-card text-danger">
                                    <div class="dash-card-container">
                                        ...
                                        <div class="dash-card-avatars">
                                            <div class="e-avatar"><img src="<?php echo e(URL::to('assets/img/profiles/avatar-09.jpg')); ?>" alt=""></div>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="dash-info-list">
                                <a href="#" class="dash-card">
                                    <div class="dash-card-container">
                                        ...
                                        <div class="dash-card-avatars">
                                            <div class="e-avatar"><img src="<?php echo e(URL::to('assets/img/profiles/avatar-02.jpg')); ?>" alt=""></div>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="dash-info-list">
                                <div class="dash-card">
                                    <div class="dash-card-container">
                                        ...
                                        <div class="dash-card-avatars">
                                            <a href="#" class="e-avatar"><img src="<?php echo e(URL::to('assets/img/profiles/avatar-04.jpg')); ?>" alt=""></a>
                                            <a href="#" class="e-avatar"><img src="<?php echo e(URL::to('assets/img/profiles/avatar-08.jpg')); ?>" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="dash-info-list">
                                <div class="dash-card">
                                    <div class="dash-card-container">
                                        ...
                                        <div class="dash-card-avatars">
                                            <a href="#" class="e-avatar"><img src="<?php echo e(URL::to('assets/img/profiles/avatar-05.jpg')); ?>" alt=""></a>
                                            <a href="#" class="e-avatar"><img src="<?php echo e(URL::to('assets/img/profiles/avatar-07.jpg')); ?>" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRS\resources\views\dashboard\emdashboard.blade.php ENDPATH**/ ?>