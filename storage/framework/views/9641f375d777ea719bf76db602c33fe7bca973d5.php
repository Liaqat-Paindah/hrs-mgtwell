	...
	<div class="main-wrapper">
		...
		<div class="header">
			...
			<div class="header-left">
				<a href="<?php echo e(url('home')); ?>" class="logo"> <img src="<?php echo e(URL::to('assets/img/logo.png')); ?>" width="100"
						alt=""></a>
			</div>
			<!-- /Logo -->
			...
			<ul class="nav user-menu">
				...
				<li class="nav-item dropdown has-arrow main-drop">
					...
					<div class="dropdown-menu">
						<a class="dropdown-item" href="<?php echo e(url('employee/profile/' . Auth::user()->rec_id)); ?>">My
							Profile</a>
...
</html><?php /**PATH C:\xampp\htdocs\HRS\resources\views\layouts\master.blade.php ENDPATH**/ ?>