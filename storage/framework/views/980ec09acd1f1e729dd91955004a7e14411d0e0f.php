            ...
            <div class="row align-items-center">
                ...
                <div class="col-auto float-right ml-auto">
                    ...
                    <div class="view-icons">
                        <a href="<?php echo e(url('all/employee/card')); ?>" class="grid-view btn btn-link active"><i class="fa fa-th"></i></a>
                        <a href="<?php echo e(url('all/employee/list')); ?>" class="list-view btn btn-link"><i class="fa fa-bars"></i></a>
                    </div>
                </div>
            </div>
        </div>
