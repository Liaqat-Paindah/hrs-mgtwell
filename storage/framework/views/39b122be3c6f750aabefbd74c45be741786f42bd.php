...
<div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-auto float-right ml-auto">
                    <a href="<?php echo e(url('form/expense/approved')); ?>" class="btn btn-warning btn-sm"><?php echo e($ExpensesCount); ?> <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
                </div>
            </div>
        </div>
...
<td> <img src="/assets/documents/<?php echo e($Expense->scanned); ?>" alt="scanned" class="col-sm-6"> </td>
<td class="text-right">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <form action="<?php echo e(url('form/expense/confirm')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRS\resources\views\reports\purchased.blade.php ENDPATH**/ ?>