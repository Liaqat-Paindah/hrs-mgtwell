            ...
            <div class="header">
                ...
                <div class="header-left">
                    <a href="<?php echo e(url('home')); ?>" class="logo">
						<img src="<?php echo e(URL::to('assets/img/logo.png')); ?>" width="40" height="40" alt="">
					</a>
                </div>
				<!-- /Logo -->
				...
				<ul class="nav user-menu">
                    ...
                    <li class="nav-item dropdown has-arrow flag-nav">
                        <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button">
                            <img src="<?php echo e(URL::to('assets/img/flags/us.png')); ?>" alt="" height="20"> <span>English</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="javascript:void(0);" class="dropdown-item"><img src="<?php echo e(URL::to('assets/img/flags/us.png')); ?>" alt="" height="16"> English</a>
                            <a href="javascript:void(0);" class="dropdown-item"><img src="<?php echo e(URL::to('assets/img/flags/kh.png')); ?>" alt="" height="16"> Khmer</a>
                        </div>
                    </li>
                    <!-- /Flag -->
...
<?php /**PATH C:\xampp\htdocs\HRS\resources\views\layouts\settings.blade.php ENDPATH**/ ?>