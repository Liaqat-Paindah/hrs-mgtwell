    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="submenu">
                    <a href="<?php echo e(url('/attendance/page')); ?>" ><i class="la la-edit"></i> <span> Attendances</span> <span
                            class="menu-arrow"></span></a>
                    <ul style="display: none;">
                        <li><a href="<?php echo e(url('/attendance/page')); ?>">Manage Attendances</a></li>
                        <li><a href="<?php echo e(url('/attendance/employee/page')); ?>">Sign Attendance</a></li>
                    </ul>
                </li>
                <li class="submenu">
                    <a href="<?php echo e(url('form/salary/page')); ?>" ><i class="la la-money"></i> <span> Payroll</span> <span
                            class="menu-arrow"></span></a>
                    <ul style="display: none;">
                        <li><a href="<?php echo e(url('form/salary/page')); ?>">Employee Salary</a></li>
                        <li><a href="<?php echo e(url('form/salary/page')); ?>">Payslip</a></li>
                    </ul>
                </li>
                <li class="submenu">
                    <a href="<?php echo e(url('form/salary/page')); ?>" ><i class="la la-pie-chart"></i> <span> Reports</span> <span
                            class="menu-arrow"></span></a>
                    <ul style="display: none;">
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-striped custom-table datatable">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $holiday; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(($today_date > $items->date_holiday)): ?>
                                        <tr class="holiday-completed">
                                            <td><?php echo e(++$key); ?></td>
                                            <td><?php echo e($items->name_holiday); ?></td>
                                            <td><?php echo e(date('d F, Y',strtotime($items->date_holiday))); ?></td>
                                            <td><?php echo e(date('l',strtotime($items->date_holiday))); ?></td>
                                            <td></td>
                                        </tr>
                                    <?php endif; ?>
                                ...
                                <?php $__currentLoopData = $holiday; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(($today_date <= $items->date_holiday)): ?>
                                        <tr class="holiday-upcoming">
                                            ...
                                            <td><?php echo e(++$key); ?></td>
                                            <td class="holidayName"><?php echo e($items->name_holiday); ?></td>
                                            <td hidden class="holidayDate"><?php echo e($items->date_holiday); ?></td>
                                            <td><?php echo e(date('d F, Y',strtotime($items->date_holiday))); ?></td>
                                            <td><?php echo e(date('l',strtotime($items->date_holiday))); ?></td>
                                            <td class="text-right">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?php echo e(url('form/holidays/save')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
        ...
        <div class="modal custom-modal fade" id="edit_holiday" role="dialog">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?php echo e(url('form/holidays/update')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRS\resources\views\form\holidays.blade.php ENDPATH**/ ?>