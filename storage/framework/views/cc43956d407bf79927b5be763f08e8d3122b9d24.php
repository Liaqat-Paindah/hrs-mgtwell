        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <form action="<?php echo e(url('form/expense/approved')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="amount" id="e_id" placeholder="Please write in Afghani">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Scanned Document <span class="text-danger">*</span></label>
                            <input type="file" class="form-control" name="scanned" id="e_id" >
                        </div>
                        <div class="submit-section">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRS\resources\views\reports\approved.blade.php ENDPATH**/ ?>