                            ...
                            <div class="profile-view">
                                <div class="profile-img-wrap">
                                    <div class="profile-img">
                                        <a href="#"><img alt="" src="<?php echo e(URL::to('/assets/images/'. $users->profile)); ?>" alt="<?php echo e($users->name); ?>"></a>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                ...
                                                <a href="<?php echo e(url('employee_pdf/'.$users->employee_id)); ?>" class="btn btn-outline-success btn-sm"> <i class="fa fa-print"></i> Print Details</a>
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                            ...
                            <div class="card profile-box flex-fill">
                                <div class="card-body">
                                    ...
                                    <table class="personal-info">
                                        ...
                                        <tr>
                                            <th class="dt-details">TIN Number:</th>
                                            <td class="dt-contents"><?php echo e($users->tin); ?></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <th class="dt-details">Address :</th>
                                            <td class="dt-contents"><?php echo e($users->address); ?></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="card profile-box flex-fill">
                                <div class="card-body">
                                    ...
                                    <table class="personal-info">
                                        <tr>
                                            <th class="dt-details">Category:</th>
                                            <td class="dt-contents"><?php echo e($users->category); ?></td>
                                        </tr>
                                        <tr>
                                            <th class="dt-details">Step:</th>
                                            <td class="dt-contents"><?php echo e($users->step); ?></td>
                                        </tr>
                                        <tr>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="profile-img-wrap edit-img">
                                        <?php if(!empty($users)): ?>
                                        <img class="inline-block" src="<?php echo e(URL::to('/assets/images/'. $users->profile)); ?>" alt="<?php echo e($users->name); ?>">
                                        <?php endif; ?>
                                        <div class="fileupload btn">
                                            <span class="btn-text">edit</span>
                                            <input class="upload" type="file" id="image" name="images">
                                            <?php if(!empty($users)): ?>
                                            <input type="hidden" name="hidden_image" id="e_image" value="<?php echo e($users->profile); ?>">
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" class="form-control" id="employee_id" name="employee_id" value="<?php echo e($users->employee_id); ?>">
                                                <input type="hidden" class="form-control" id="email" name="email" value="<?php echo e($users->email); ?>">
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="cal-icon">
                                                    <?php if(!empty($users)): ?>
                                                    <input class="form-control datetimepicker" type="text" id="birthDate" name="birthDate" value="<?php echo e($users->birth_date); ?>">
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="cal-icon">
                                                    <?php if(!empty($users)): ?>
                                                    <input class="form-control" type="text" id="nid" name="nid" value="<?php echo e($users->nid); ?>">
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="cal-icon">
                                                    <?php if(!empty($users)): ?>
                                                    <input class="form-control " type="text" id="position" name="position" value="<?php echo e($users->position); ?>">
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="cal-icon">
                                                    <?php if(!empty($users)): ?>
                                                    <input class="form-control " type="text" id="created_at" name="created_at" value="<?php echo e($users->created_at); ?>">
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="cal-icon">
                                                    <?php if(!empty($users)): ?>
                                                    <input class="form-control " type="number" id="phone" name="phone" value="<?php echo e($users->phone); ?>">
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="cal-icon">
                                                    <?php if(!empty($users)): ?>
                                                    <input class="form-control " type="email" id="email" name="email" value="<?php echo e($users->email); ?>">
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="cal-icon">
                                                    <?php if(!empty($users)): ?>
                                                    <input class="form-control " type="text" id="blood_group" name="blood_group" value="<?php echo e($users->blood_group); ?>">
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="select form-control" id="gender" name="gender">
                                                    <?php if(!empty($users)): ?>
                                                    <option value="<?php echo e($users->gender); ?>" <?php echo e(( $users->gender == $users->gender) ? 'selected' : ''); ?>><?php echo e($users->gender); ?> </option>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Address</label>
                                        <?php if(!empty($users)): ?>
                                        <input type="text" class="form-control" id="address" name="address" value="<?php echo e($users->address); ?>">
                                        <?php endif; ?>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRS\resources\views\usermanagement\profile_user.blade.php ENDPATH**/ ?>