                            ...
                            <tr>
                                <td>
                                    <h2 class="table-avatar">
                                        <a href="<?php echo e(url('employee/attendance_details/'.$attendance->rec_id)); ?>" class="avatar">
                                            <img alt="" src="<?php echo e(URL::to('/assets/images/'. $attendance->profile)); ?>">
                                        </a>
                                        <a href="<?php echo e(url('employee/attendance_details/'.$attendance->rec_id)); ?>">
                                            <?php echo e($attendance->name); ?><span><?php echo e($attendance->position); ?></span>
                                        </a>
                                    </h2>
                                </td>
                                ...
                                <td>
                                    <?php if($attendance->clock_in_time): ?>
                                        <?php echo e(\Carbon\Carbon::parse($attendance->clock_in_time)->timezone('Asia/Kabul')->format('h:i A')); ?>
                                ...
                                <td>
                                    <?php if($attendance->clock_out_time): ?>
                                        <?php echo e(\Carbon\Carbon::parse($attendance->clock_out_time)->timezone('Asia/Kabul')->format('h:i A')); ?>
                                ...
                                <td><?php echo e(\Carbon\Carbon::parse($attendance->created_at)->format('Y')); ?></td>
                                ...
                                <td class="text-right">
                                    <div class="dropdown dropdown-action">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="<?php echo e(url('attendance_details/delete/'.$attendance->rec_id.'/'.$attendance->date)); ?>" onclick="return confirm('Are you sure to want to delete it?')">
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?php echo e(url('payment/employee/save')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-sm-6">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRS\resources\views\form\attendance_details.blade.php ENDPATH**/ ?>