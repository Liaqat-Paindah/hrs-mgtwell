                                    ...
                                    <table class="table table-hover table-nowrap leave-table mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>5</td>
                                                <td>
                                                    <a href="#" class="avatar"><img alt="" src="<?php echo e(URL::to('assets/img/profiles/avatar-02.jpg')); ?>"></a>
                                                    <a href="#">John Doe</a>
                                                </td>
                                                <td class="text-right">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRS\resources\views\form\leavesettings.blade.php ENDPATH**/ ?>