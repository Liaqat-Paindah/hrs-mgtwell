	...
	<div class="main-wrapper">
		...
		<div class="header">
			...
			<div class="header-left">
				<a href="{{ url('home') }}" class="logo"> <img src="{{ URL::to('assets/img/logo.png') }}" width="100"
						alt=""></a>
			</div>
			<!-- /Logo -->
			...
			<ul class="nav user-menu">
				...
				<li class="nav-item dropdown has-arrow main-drop">
					...
					<div class="dropdown-menu">
						<a class="dropdown-item" href="{{ url('employee/profile/' . Auth::user()->rec_id) }}">My
							Profile</a>
						<a class="dropdown-item" href="{{ url('change/password') }}">Setting</a>
