            ...
            <div class="row align-items-center">
                ...
                <div class="float-right">
                    <div class="col-sm-12 mx-0 px-1">
                        <a href="{{ url('attendance_export')}}" target="_blank" class="btn btn-outline-success btn-sm" rel="noopener noreferrer"> <i class="fa fa-print"></i> Export XSL </a>
                    </div>
                </div>
                                    ...
                                    <div class="dropdown dropdown-action">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item"
                                                href="{{url('attendancelist/delete/'.$attendance->rec_id)}}"
