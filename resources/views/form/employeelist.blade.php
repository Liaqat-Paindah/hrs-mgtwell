        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-auto float-right ml-auto">
                    ...
                    <a href="{{url('all/employee/export')}}" class="btn add-btn btn-sm m-2"><i class="fa fa-file-excel-o"></i> Export</a>
                    <div class="view-icons">
                        <a href="{{ url('all/employee/card') }}" class="grid-view btn btn-link active"><i class="fa fa-th"></i></a>
                        <a href="{{ url('all/employee/list') }}" class="list-view btn btn-link"><i class="fa fa-bars"></i></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <table class="table table-striped custom-table datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $items->email }}</td>
                                <td>{{ $items->phone }}</td>
                                <td>{{ $items->account_status }}</td>
                                <td>{{ $items->position }}</td>
<td>{{ \Carbon\Carbon::parse($items->created_at)->format('d-m-Y') }}</td>
<td>{{ \Carbon\Carbon::parse($items->updated_at)->format('d-m-Y') }}</td>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ url('all/employee/save') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <!-- Name Selection -->
                                <div class="col-sm-6">
