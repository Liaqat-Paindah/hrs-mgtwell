                ...
                <ul>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            ...
                            <li><a href="{{ url('em/dashboard') }}">Employee Dashboard</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            <li><a href="{{ url('all/employee/card') }}">All Employees</a></li>
                            <li><a href="{{ url('form/holidays/new') }}">Holidays</a></li>
                            <li><a href="{{ url('form/leaves/new') }}">Leaves (Admin) 
                                <span class="badge badge-pill bg-primary float-right">1</span></a>
                            </li>
                            <li><a href="{{url('form/leavesemployee/new')}}">Leaves (Employee)</a></li>
                            <li><a href="{{ url('form/leavesettings/page') }}">Leave Settings</a></li>
                            <li><a href="{{ url('attendance/page') }}">Attendance (Admin)</a></li>
                            <li><a href="{{ url('attendance/employee/page') }}">Attendance (Employee)</a></li>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            ...
                            <li><a class="active" href="{{ url('form/invoice/view/page') }}">Invoices</a></li>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            ...
                            <li><a href="{{ url('form/payroll/items') }}"> Payroll Items </a></li>
                        </ul>
                    </li>
                    <li class="submenu">
                        <a href="#">
                        ...
                        <ul style="display: none;">
                            <li><a href="{{ url('form/expense/reports/page') }}"> Expense Report </a></li>
                            <li><a href="{{ url('form/invoice/reports/page') }}"> Invoice Report </a></li>
                            <li><a href="payments-reports.html"> Payments Report </a></li>
                            <li><a href="employee-reports.html"> Employee Report </a></li>
                            <li><a href="payslip-reports.html"> Payslip Report </a></li>
                            <li><a href="attendance-reports.html"> Attendance Report </a></li>
                            <li><a href="{{ url('form/leave/reports/page') }}"> Leave Report </a></li>
                            <li><a href="{{ url('form/daily/reports/page') }}"> Daily Report </a></li>
                        </ul>
                    </li>
                    <li class="menu-title"> 
                    ...
                    <li class="submenu"> 
                        ...
                        <ul style="display: none;">
                            <li><a class="active" href="{{ url('form/performance/indicator/page') }}"> Performance Indicator </a></li>
                            <li><a href="{{ url('form/performance/page') }}"> Performance Review </a></li>
                            <li><a href="{{ url('form/performance/appraisal/page') }}"> Performance Appraisal </a></li>
                        </ul>
                    </li>
                    <li class="submenu"> <a href="#"><i class="la la-edit"></i>
                        <span> Training </span> <span class="menu-arrow"></span></a>
                        <ul style="display: none;">
                            <li><a href="{{ url('form/training/list/page') }}"> Training List </a></li>
                            <li><a href="{{ url('form/trainers/list/page') }}"> Trainers</a></li>
                            <li><a href="{{ url('form/training/type/list/page') }}"> Training Type </a></li>
                        </ul>
                    </li>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ url('form/performance/indicator/save') }}" method="POST">
                            @csrf
        ...
        <div id="edit_indicator" class="modal custom-modal fade" role="dialog">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ url('form/performance/indicator/update') }}" method="POST">
                            @csrf
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <div class="modal-btn delete-action">
                            <form action="{{ url('form/performance/indicator/delete') }}" method="POST">
                                @csrf
