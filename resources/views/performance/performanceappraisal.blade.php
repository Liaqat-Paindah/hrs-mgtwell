            ...
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li class="submenu"> 
                        ...
                        <ul style="display: none;">
                            <li><a href="{{ url('form/performance/indicator/page') }}"> Performance Indicator </a></li>
                            <li><a href="{{ url('form/performance/page') }}"> Performance Review </a></li>
                            <li><a class="active" href="{{ url('form/performance/appraisal/page') }}"> Performance Appraisal </a></li>
                        </ul>
                    </li>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ url('form/performance/appraisal/save') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-sm-12">
        ...
        <div id="edit_appraisal" class="modal custom-modal fade" role="dialog">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ url('form/performance/appraisal/update') }}" method="POST">
                            @csrf
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <div class="modal-btn delete-action">
                            <form action="{{ url('form/performance/appraisal/delete') }}" method="POST">
                                @csrf
