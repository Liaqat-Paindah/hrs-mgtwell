            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ url('all/employee/list') }}">Employees</a></li>
                            ...
                            <div class="profile-view">
                                <div class="profile-img-wrap">
                                    <div class="profile-img">
                                        <a href="#"><img alt="" src="{{ URL::to('/assets/images/'. $users->profile) }}" alt="{{ $users->name }}"></a>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                <h3 class="user-name mt-2 mb-0">{{ $users->name }} </h3>
                                                ...
                                                <a href="{{ url('employee_pdf/'.$users->employee_id) }}" class="btn btn-outline-success btn-sm"> <i class="fa fa-print"></i> Print Details</a>
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="personal-info">
                                        ...
                                        <tr>
                                            ...
                                            <td class="dt-contents">{{ $users->tin }}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="dt-contents">{{ $users->address }}</td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="personal-info">
                                        <tr>
                                            ...
                                            <td class="dt-contents">{{ $users->category }}</td>
                                        </tr>
                                        <tr>
                                            <th class="dt-details">Step:</th>
                                            <td class="dt-contents">{{ $users->step }}</td>
                                        </tr>
                                        <tr>
                                            <th class="dt-details">Gross Salary:</th>
                                            <td class="dt-contents">{{ $users->gross_salary }} Afghani</td>
                                        </tr>
                                        <tr>
                                            <th class="dt-details">Tax:</th>
                                            <td class="dt-contents">{{ $users->tax }} Afghani</td>
                                        </tr>
                                        <tr>
                                            <th class="dt-details">Net Salary:</th>
                                            <td class="dt-contents">{{ $users->net_salary }} Afghani</td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ url('profile/information/save') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="profile-img-wrap edit-img">
                                        @if(!empty($users))
                                        <img class="inline-block" src="{{ URL::to('/assets/images/'. $users->profile) }}" alt="{{ $users->name }}">
                                        @endif
                                        <div class="fileupload btn">
                                            <span class="btn-text">edit</span>
                                            <input class="upload" type="file" id="image" name="images">
                                            @if(!empty($users))
                                            <input type="hidden" name="hidden_image" id="e_image" value="{{ $users->profile }}">
                                            @endif
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="cal-icon">
                                                    @if(!empty($users))
                                                    <input class="form-control" type="text" id="nid" name="nid" value="{{ $users->nid }}">
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="cal-icon">
                                                    @if(!empty($users))
                                                    <input class="form-control " type="text" id="position" name="position" value="{{ $users->position }}">
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="cal-icon">
                                                    @if(!empty($users))
                                                    <input class="form-control " type="text" id="created_at" name="created_at" value="{{ $users->created_at }}">
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="cal-icon">
                                                    @if(!empty($users))
                                                    <input class="form-control " type="number" id="phone" name="phone" value="{{ $users->phone }}">
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="cal-icon">
                                                    @if(!empty($users))
                                                    <input class="form-control " type="text" id="blood_group" name="blood_group" value="{{ $users->blood_group }}">
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
