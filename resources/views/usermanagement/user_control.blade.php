                        ...
                        <table class="table table-striped custom-table datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ \Carbon\Carbon::create()->parse($user->join_date)->format('Y-m-d') }}</td>
                                    <td>
                                        @if ($user->role_name=='Admin')
                                            <span data-toggle="modal" data-id="{{ $user->rec_id }}" data-target="#approve_leave" class="badge bg-inverse-danger role_name">{{ $user->role_name }}</span>
                                            @elseif ($user->role_name=='Manager')
                                            <span data-toggle="modal" data-id="{{ $user->rec_id }}" data-target="#approve_leave" class="badge bg-inverse-warning role_name">{{ $user->role_name }}</span>
                                            @elseif ($user->role_name=='Finance')
                                            <span data-toggle="modal" data-id="{{ $user->rec_id }}" data-target="#approve_leave" class="badge bg-inverse-info role_name">{{ $user->role_name }}</span>
                                            @elseif ($user->role_name=='Line-Manager')
                                            <span data-toggle="modal" data-id="{{ $user->rec_id }}" data-target="#approve_leave" class="badge bg-inverse-info role_name">{{ $user->role_name }}</span>

                                            @elseif ($user->role_name=='Employee')
                                            <span data-toggle="modal" data-id="{{ $user->rec_id }}" data-target="#approve_leave"  class="badge bg-inverse-dark role_name">{{ $user->role_name }}</span>
                                        @endif
                                    </td>
                                    <td class="text-right">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <form action="{{ url('form/user/confirm') }}" method="POST">
                        @csrf
